...
function SignupForm() {
  ...
  const { firstName, lastName, email,address, password, confirmPassword } = formData
  ...
  return (
    <div>
      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4">
        ...
        <button
          type="submit"
          className="mt-6 rounded-[8px] bg-indigo-300 py-[8px] px-[12px] font-medium text-richblack-900"
        >
          Create Account
        </button>
      </form>
